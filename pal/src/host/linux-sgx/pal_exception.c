...
static inline bool get_tickle_pages(sgx_cpu_context_t* uc, uintptr_t *stp, uintptr_t *dtp, uintptr_t *ctp, uintptr_t *c3_byte)
{
...
extern void _apply_mitigation_and_restore_sgx_context(sgx_cpu_context_t* uc, PAL_XREGS_STATE* xsave_area, uintptr_t stp, uintptr_t dtp, uintptr_t ctp, uintptr_t c3_byte_address);
